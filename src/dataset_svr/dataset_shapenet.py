...
class ShapeNet(data.Dataset):
    ...
    def __init__(self, opt, train=True):
        self.opt = opt
        self.num_sample = opt.number_points if train else 2048
        self.train = train
...
if __name__ == '__main__':
    ...
    opt = {"pointcloud_path": 'Path/ShapeNetV1PointCloud/',
           "image_path": 'Path/ShapeNetV1Renderings/',
           "cache_path": "Path/cache/",
            "cache_path_test": "Path/cache_test/",
           "normalization": "UnitBall", "class_choice": ["airplane"], "SVR": True, "sample": True, "npoints": 2500,
           "demo": False,"shapenet13": True}
